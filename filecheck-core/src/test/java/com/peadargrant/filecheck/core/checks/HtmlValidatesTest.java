 ...
 * @author peadar
 */
public class HtmlValidatesTest {
    ...
    public void validCssShouldPass() throws IOException {
        InputStream input = this.getClass().getResourceAsStream("HtmlValidatesTest_valid.html");
    ...
    public void invalidCssShouldFail() throws IOException {
        InputStream input = this.getClass().getResourceAsStream("HtmlValidatesTest_invalid.html");
        instance.runCheck(input, result);
